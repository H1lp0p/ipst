function solution1(input : String){
  ...
  function solution2(input: string){
    ...
    words = words.map((x : string) => x[0].toString().repeat(x.length))
    return words.join(' ')
  }
